...
(function (TorusCycle) {
    var width, height, camera, light, scene, renderer, subject,
            cameraController, resources, computer, clock;
    ...
    TorusCycle.start = function (container) {
        init(container);
    };
}(TorusCycle));
...
function changesSign(base, subtract) {
